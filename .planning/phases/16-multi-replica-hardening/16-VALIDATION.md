...
| 16-06-xx | 06 | 3 | SCALE-06 | — | All lobby clients receive hub events regardless of sending replica under restart + Redis reconnect | integration (2 replicas, Redis backplane) | `dotnet test tests/GameKit.Lobby.Integration.Tests` | ⚠️ extends BackplaneTests | ⬜ pending |
...
- [ ] Extend `GameKit.Lobby.Integration.Tests/BackplaneTests.cs` with replica-restart + Redis reconnect (SCALE-06)
