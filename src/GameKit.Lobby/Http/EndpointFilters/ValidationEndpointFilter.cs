...
namespace GameKit.Lobby.Http.EndpointFilters;
...
/// <c>GameKit.Core.Http.EndpointFilters.ValidationEndpointFilter</c> and
/// <c>GameKit.Matchmaking.Http.EndpointFilters.ValidationEndpointFilter</c> analogs —
/// the Lobby namespace owns this copy so imports remain local to the package.
/// </summary>
