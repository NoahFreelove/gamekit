...
{
    /// <summary>
    /// DR-05/DR-07 ordering anchor: zero-DDL migration that advances the Matchmaking package's
    /// latest migration timestamp to <c>20260626000000</c>, ensuring the canonical
    /// application order Rankings(20260625) &lt; Matchmaking(20260626) holds lexicographically.
    /// No schema changes — empty Up(), DR-04-compliant Down().
    /// </summary>
    [Migration("20260626000000_DrOrderingMarker")]
