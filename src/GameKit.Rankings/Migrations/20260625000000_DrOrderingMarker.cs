...
{
    /// <summary>
    /// DR-05/DR-07 ordering anchor: zero-DDL migration that advances the Rankings package's
    /// latest migration timestamp to <c>20260625000000</c>, ensuring the canonical
    /// application order Admin(20260624) &lt; Rankings(20260625) holds lexicographically.
    /// No schema changes — empty Up(), DR-04-compliant Down().
    /// </summary>
    [Migration("20260625000000_DrOrderingMarker")]
